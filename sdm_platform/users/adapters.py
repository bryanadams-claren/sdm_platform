...
class AccountAdapter(DefaultAccountAdapter):
    ...
    def get_email_confirmation_url(
        ...
        By default, allauth uses a magic link that confirms and redirects.
        """
...
class SocialAccountAdapter(DefaultSocialAccountAdapter):
    ...
    def populate_user(
        ...
        # Auto-grant staff status to users from clarenhealth.com domain
        if user.email and user.email.lower().endswith("@clarenhealth.com"):
            user.is_staff = True
