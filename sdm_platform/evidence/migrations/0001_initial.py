    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('journey', models.ForeignKey(blank=True, help_text="If set, this evidence only applies to this journey's RAG retrieval", null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='evidence_documents', to='journeys.journey')),
